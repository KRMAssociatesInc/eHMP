...
var writebacksaveopmedorder = require('../resources/writebackmed/writebackopmedorderResource');
...
describe('Outpatient Med Order Save Resource', function() {
    it('tests that getResourceConfig() is setup correctly', function() {
        ...
        expect(resources[0].name).toEqual('save');
        expect(resources[0].path).toEqual('/save');
...
describe('Outpatient Med Order Save Verification', function() {
    ...
    it('tests valid order record', function() {
        ...
        expect(result.errMsg.length).toEqual(0);
    });
    ...
    it('tests missing patient ien', function() {
        ...
        expect(result.errMsg).toEqual('This order cannot be saved for the following reason(s):\nRequired data is missing.\n');
    });
