...
var solrSimpleClient = require('./solrSimpleClient');
...
var loincSearch = require('./loincSearch');
var labPanelSearch = require('./labPanelSearch');
var labGroupSearch = require('./labGroupSearch');
var ontologyClient = require('./ontologyClient');
...
function suggestSearch(req, res, next) {
        ...
        async.map(tasks,
            ...
            function(err, results) {
                if (err) {
                    res.send(500, 'The search could not be completed\n' + err.stack);
                    return;
                }
                ...
                res.send(hmpEmulatedSuggestResponseObject);
