...
var whiteList = rdk.dataParseConfig.encounters.appointmentStatus || [];
...
function getData(req, callback) {
    ...
    async.parallel({
            encounters: function(callback) {
                makeJdsCall(req.app.config.jdsServer, '/vpr/' + pid + '/index/encounter', req.logger, callback);
            }
        },
...
function makeJdsCall(jdsServer, jdsPath, logger, callback) {
