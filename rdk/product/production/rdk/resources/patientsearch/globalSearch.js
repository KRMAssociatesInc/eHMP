...
var mvi = require('../../subsystems/mvi/mviSubsystem');
...
var xml_1305_ssn = fs.readFileSync('./resources/patientsearch/xml/1305-ssn.xml').toString();
var xml_1305_dob = fs.readFileSync('./resources/patientsearch/xml/1305-dob.xml').toString();
var xml_1305_fullName = fs.readFileSync('./resources/patientsearch/xml/1305-fullName.xml').toString();
var xml_1305_firstName = fs.readFileSync('./resources/patientsearch/xml/1305-firstName.xml').toString();
var xml_1305_lastName = fs.readFileSync('./resources/patientsearch/xml/1305-lastName.xml').toString();
var xml_1305 = fs.readFileSync('./resources/patientsearch/xml/1305.xml').toString();
...
module.exports.getGlobalSearch = function(req, res) {
    ...
    if (errorMessage) {
        res.status(rdk.httpstatus.not_acceptable).send(errorMessage);
    } else {
...
function queryGlobalSearch(config, queryParams, request, response, next) {
    ...
    try {
        http.post(soapRequest, httpConfig, function(statusCode, data) {
            if (statusCode !== undefined) {
                ...
                parseString(data, function(err, result) {
                    if (!err) {
                        ...
                        response.json(next(searchUtil.retrieveObjFromTree(result, ['Envelope', 'Body', 0, 'PRPA_IN201306UV02', 0]),request)); //throw away soap envelope
                    } else {
