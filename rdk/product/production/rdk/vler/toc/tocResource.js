...
var sections = {
    ...
    problems: require('./problemsSection'),
    encounters: require('./encountersSection'),
    allergies: require('./allergiesSection'),
    medications: require('./medicationsSection'),
    vitalsigns: require('./vitalsignsSection'),
    procedures: require('./proceduresSection'),
    immunizations: require('./immunizationsSection'),
    results: require('./resultsSection'),
    assessment: require('./assessmentSection'),
    planOfCare: require('./planOfCareSection')
};
