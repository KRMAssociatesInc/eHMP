...
this["Handlebars"]["templates"]["main"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, helperMissing=helpers.helperMissing, functionType="function", escapeExpression=this.escapeExpression, buffer = "<!--<div class='info' id='api_info'>-->\n    <!--";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.info : depth0), {"name":"if","hash":{},"fn":this.program(1, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "-->\n<!--</div>-->\n\n";
  stack1 = ((helpers.eq || (depth0 && depth0.eq) || helperMissing).call(depth0, ((stack1 = (depth0 != null ? depth0.info : depth0)) != null ? stack1.host : stack1), "local", {"name":"eq","hash":{},"fn":this.program(14, data),"inverse":this.program(16, data),"data":data}));
  if (stack1 != null) { buffer += stack1; }
  buffer += "\n<div class=\"row-fluid\">\n    <div class=\"span4\" id=\"sidebar\">\n    <!--<div class=\"span4\" id=\"sidebar\" role=\"navigation\" data-spy=\"scroll\" data-target=.nav\" data-offset=\"100\">-->\n        <!-- documentation -->\n\n        <!--<ul class=\"nav nav-list\">-->\n            <!--<li><a href=\"#info-a\" data-toggle=\"\" data-target=\"#info-a-sub\">Consuming the API</a>-->\n                <!--<ul class=\"nav\" id=\"info-a-sub\">-->\n                    <!--<li><a href=\"#info-a.1\"></a></li>-->\n                    <!--<li><a href=\"#info-a.2\"></a></li>-->\n                <!--</ul>-->\n            <!--</li>-->\n        <!--</ul>-->\n\n        <div class=\"row-fluid\">\n            <div class=\"documentation\">\n\n                <section><h1>Consuming the API</h1>\n\n                    <section class=\"subsection\"><h2>Authentication</h2>\n                        <p>To begin, use the <code>authentication-authentication</code> resource to establish a session.</p>\n                    </section><!-- end authentication -->\n\n                    <section class=\"subsection\"><h2>Parameters</h2>\n\n                        <section><h3><code>pid</code></h3>\n                            <p>Resources that deal with patient information accept a patient id as icn, site;dfn, or dfn.</p>\n                        </section>\n\n                        <section><h3><code>fields</code></h3>\n                            <p>Define which fields to return using:</p>\n                            <ul>\n                                <li>- a,b,c comma-separated list to select multiple fields</li>\n                                <li>- a/b/c path to select a field from its parent</li>\n                                <li>- a(b,c) sub-selection to select many fields from a parent</li>\n                            </ul>\n                            Reference: <a href=\"https://github.com/nemtsov/json-mask\">json-mask</a>\n                        </section>\n\n                        <section><h3><code>filter</code></h3>\n                            <p>*jds filter placeholder*</p>\n                        </section>\n\n                    </section><!-- end parameters -->\n                </section>\n\n            </div><!-- end documentation -->\n        </div><!-- end nested row -->\n\n    </div><!-- end sidebar -->\n\n    <div class='container span8' id='resources_container'>\n      <ul id='resources'></ul>\n    </div><!-- end resources -->\n\n    <footer class=\"footer navbar-fixed-bottom\">\n        <div class=\"bs container\">\n            <h4 style=\"color: #999\">[ <span style=\"font-variant: small-caps\">base url</span>: "
    ...
    + "\n";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 != null ? depth0.info : depth0)) != null ? stack1.version : stack1), {"name":"if","hash":{},"fn":this.program(18, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  buffer += "]\n";
  stack1 = helpers['if'].call(depth0, (depth0 != null ? depth0.validatorUrl : depth0), {"name":"if","hash":{},"fn":this.program(20, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer + "            </h4>\n        </div>\n    </footer>\n</div><!-- end main row -->\n";
},"useData":true});
this["Handlebars"]["templates"]["operation"] = Handlebars.template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, helper, options, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, blockHelperMissing=helpers.blockHelperMissing, buffer = "\n  <ul class='operations' >\n    <li class='"
    ...
    + "/"
    + escapeExpression(((helper = (helper = helpers.nickname || (depth0 != null ? depth0.nickname : depth0)) != null ? helper : helperMissing),(typeof helper === functionType ? helper.call(depth0, {"name":"nickname","hash":{},"data":data}) : helper)))
    + "' class=\"resource-title toggleOperation ";
