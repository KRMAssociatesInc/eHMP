...
var writebacksavemedication = require('./writebackmedicationsaveResource');
...
describe('writebacksavemedication', function() {
    describe('call function verifyInput', function() {
        ...
        it('tests missing ien', function() {
            expect(writebacksavemedication.verifyInput(saveMedJSON).valid).not.to.be.true();
        });
        ...
        it('tests valid input', function() {
            ...
            expect(writebacksavemedication.verifyInput(saveMedJSON).valid).to.be.true();
        });
