...
var writebackmedoperationaldata = require('./operationaldataResource');
...
describe('writebackmed_operationaldataResource', function(test) {
    ...
    describe('call function getMedSearchList', function() {
        ...
        beforeEach(function() {
            req = {};
            sinon.stub(rdk.utils.http, 'fetch');
        });
        ...
        it('with search set to \'alc\', ' +
            'count set to \'10\'', function() {
                ...
                expect(rdk.utils.http.fetch.called).to.be.true();
            });
    });
    ...
    describe('Test Helper Methods', function() {
        it('Test buildMedResultList', function() {
            ...
            var actual = writebackmedoperationaldata._buildMedResultList(input);
            expect(JSON.stringify(actual)).to.equal(JSON.stringify(expected_output));
        });
        ...
        it('Test buildMedSchedules', function() {
            ...
            var actual = writebackmedoperationaldata._buildMedSchedules(input);
            expect(JSON.stringify(actual)).to.eql(JSON.stringify(expected_output));
        });
        ...
        it('Test buildMedDefaults', function() {
            ...
            var actual = writebackmedoperationaldata._buildMedDefaults(input);
            expect(JSON.stringify(actual)).to.eql(JSON.stringify(expected_output));
        });
        ...
        it('Test getOrderPresets', function() {
            ...
            var actual = writebackmedoperationaldata._buildOrderPresets(input);
            expect(JSON.stringify(actual)).to.eql(JSON.stringify(expected_output));
        });
        ...
        it('Test buildDialogFormats', function() {
            ...
            var actual = writebackmedoperationaldata._buildDialogFormat(input);
            expect(JSON.stringify(actual)).to.eql(JSON.stringify(expected_output));
        });
    ...
    describe('getDayToQuantity Verification', function() {
        ...
        it('test for valid dose', function(){
            ...
            result = writebackmedoperationaldata._verifyDayToQuantity(requestParameters);
            expect(result).to.equal('There was no \'dose\' string in the request.\n');
        });
        it('test for valid schedule', function(){
            delete requestParameters.schedule;
            result = writebackmedoperationaldata._verifyDayToQuantity(requestParameters);
            expect(result).to.equal('There was no \'schedule\' string in the request.\n');
        });
