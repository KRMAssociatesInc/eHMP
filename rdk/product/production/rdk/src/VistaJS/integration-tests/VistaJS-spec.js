...
xdescribe('Verify authentication', function() {
...
xdescribe('Verify allergy match', function() {
...
xdescribe('Verify get user info', function() {
...
xdescribe('Fetch Symptoms integration test', function() {
