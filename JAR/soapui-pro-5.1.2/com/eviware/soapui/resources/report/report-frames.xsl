<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0"
    ...
    xmlns:stringutils="xalan://com.eviware.soapui.support.StringUtils"
    extension-element-prefixes="redirect">
<xsl:output method="html" indent="yes" encoding="UTF-8"/>
<xsl:decimal-format decimal-separator="." grouping-separator=","/>
<!--

 soapUI frames-report
-->
...
<xsl:template match="testsuites" mode="all.tests">
	...
	<xsl:variable name="title">
		...
		<xsl:otherwise>
		    <xsl:text>All TestCases</xsl:text>
		</xsl:otherwise>
	    </xsl:choose>
	</xsl:variable>
	<head>
	    <title>SoapUI Test Results: <xsl:value-of select="$title"/></title>
...
<xsl:template match="testsuite" mode="class.details">
    ...
    <html>
        <head>
          <title>SoapUI Test Results: <xsl:value-of select="$class.name"/></title>
            <xsl:call-template name="create.stylesheet.link">
       ...
       <script type="text/javascript" language="JavaScript"><![CDATA[
        function displayProperties (name) {
          var win = window.open('','soapUISystemProperties','scrollbars=1,resizable=1');
        ...
        <body>
            <xsl:call-template name="pageHeader"/>
            <h3>TestSuite <xsl:value-of select="$class.name"/></h3>
...
<xsl:template name="classes.list">
    ...
    <html>
        <head>
            <title>SoapUI TestSuites: <xsl:value-of select="$name"/></title>
            <xsl:call-template name="create.stylesheet.link">
...
<xsl:template match="testsuites" mode="all.classes">
    <html>
        <head>
            <title>All SoapUI TestSuites</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
...
<xsl:template match="testsuites" mode="all.packages">
    <html>
        <head>
            <title>All SoapUI Projects</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
...
<xsl:template match="testsuites" mode="overview.packages">
    <html>
        <head>
            <title>SoapUI Test Results: Summary</title>
            <xsl:call-template name="create.stylesheet.link">
                <xsl:with-param name="package.name"/>
            </xsl:call-template>
        </head>
