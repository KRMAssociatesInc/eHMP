...
usage()
{
    ...
    This script will create a JDS instance for GT.M
...
# Add firewall rules
if [[ $RHEL || -z $ubuntu ]]; then
    sudo iptables -I INPUT 1 -p tcp --dport 9080 -j ACCEPT
    sudo iptables -I INPUT 1 -p tcp --dport 9081 -j ACCEPT
    sudo iptables -I INPUT 1 -p tcp --dport 9082 -j ACCEPT
    sudo iptables-save
fi

echo "JDS instance $instance created!"
