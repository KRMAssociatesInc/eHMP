...
var inputValue = {
    ...
    'data': {
        ...
        'items': [{
            ...
            'resulted': '199912011344',
            'specimen': 'BLOOD',
            'comment': 'Ordering Provider: Fiftythree Wardclerk Report Released Date/Time: Dec 01, 1999@13:44\r\n Performing Lab: ALBANY VA MEDICAL CENTER\r\n VA MEDICAL CENTER 1 3RD sT. ALBANY, NY 12180-0097\r\n ',
            'typeCode': 'urn:lnc:2601-3',
            'typeName': 'MAGNESIUM',
            'displayName': 'MG',
            'result': '2.3',
            'resultNumber': 2.3,
            ...
            'displayName': 'CULTURE & SUSCEPTIBILITY',
            'kind': 'Microbiology',
            'abnormal': false,
            'lnccodes': ['urn:lnc:18725-2'],
            'codes': [{
                'code': '18725-2',
                'system': 'urn:oid:2.16.840.1.113883.6.1',
            ...
            'codes': [{
                'code': '26439-0',
                'system': 'urn:oid:2.16.840.1.113883.6.1',
                'display': 'Surgical pathology studies (set)'
            }],
            'qualifiedName': 'WART',
            'statusCode': 'urn:va:lab-status:completed',
            'organizerType': 'accession',
            ...
            'codes': [{
                'code': '50668-3',
                'system': 'urn:oid:2.16.840.1.113883.6.1',
                'display': 'Microscopic observation in Unspecified specimen by Electron microscopy Narrative'
            }],
            'qualifiedName': 'WART',
            'statusCode': 'urn:va:lab-status:completed',
            'organizerType': 'accession',
