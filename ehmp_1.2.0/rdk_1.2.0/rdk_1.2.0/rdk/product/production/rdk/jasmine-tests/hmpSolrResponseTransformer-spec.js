...
var solrSimpleClient = require('../resources/patientrecord/search/solrSimpleClient');

var hmpSolrResponseTransformer = require('../resources/patientrecord/search/hmpSolrResponseTransformer');
...
describe('update cumulative response data', function () {
    it('should add facets', function () {
        ...
        expect(cumulativeResponseData.data.facets.all).toBeGreaterThan(0);
    });
    ...
    it('should update facets', function () {
        ...
        expect(cumulativeResponseData.data.facets.all).toBe(
    ...
    it('should accumulate QTime', function () {
        ...
        expect(cumulativeResponseData.data.elapsed).toBe(
...
describe('transform solr highlighting to hmp object', function () {
    it('should put solr highlighting into an hmp object', function () {
        ...
        expect(hmpEmultatedResponseObject.data.items[0].highlights.length).toBeGreaterThan(0);
    });
});
...
describe('transform solr items to hmp format', function () {
    it('should handle grouped items', function () {
        ...
        expect(hmpObject.data.items.length)
            .toEqual(solrResponse.grouped.qualified_name.groups[0].doclist.docs.length);
    });
    ...
    it('should handle ungrouped items', function () {
        ...
        expect(hmpObject.data.items.length)
            .toEqual(solrResponse.response.docs.length);
    });
});
...
describe('get searched domain from solr response', function () {
    it('should handle searching from a domain', function () {
        ...
        expect(searchedDomain).toBe('procedure');
    });
});
