...
public interface IJMeadowsVitalService {
    /**
     * Retrieve the vital data and format it into a VistaChunk to be included into the set of data returned to the system.
     *
