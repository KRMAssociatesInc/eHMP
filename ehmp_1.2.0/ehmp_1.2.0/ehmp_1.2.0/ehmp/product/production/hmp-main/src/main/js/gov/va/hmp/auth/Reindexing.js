Ext.define('gov.va.hmp.auth.Reindexing', {
    extend: 'gov.va.hmp.Application',
    requires: [
        'gov.va.hmp.Viewport',
        'gov.va.hmp.AppContext',
        'gov.va.hmp.auth.ReindexingController',
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'container',
                            itemId: 'reindexStatusProgressArea',
                            layout: {
                                type: 'vbox',
                                align: 'center'
                            },
                            items: [{
                                xtype: 'component',
                                html: '<h4>Reindexing patient data</h4>'
                            }]
                        }
                    ]
                }
