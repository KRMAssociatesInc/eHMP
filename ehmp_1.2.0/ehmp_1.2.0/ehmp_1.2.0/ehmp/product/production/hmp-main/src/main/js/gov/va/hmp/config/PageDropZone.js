/**
 * @class gov.va.hmp.config.PageDropZone
 * @extends Ext.dd.DropTarget
 * Internal class that manages drag/drop for {@link Ext.app.PortalPanel}.
 */
Ext.define('gov.va.hmp.config.PageDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        gov.va.hmp.config.PageDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        gov.va.hmp.config.PageDropZone.superclass.unreg.call(this);
    }
});
