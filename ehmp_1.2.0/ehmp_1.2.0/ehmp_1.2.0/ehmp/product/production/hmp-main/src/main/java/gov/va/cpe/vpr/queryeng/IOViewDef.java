...
@Component(value = "gov.va.cpe.vpr.queryeng.IOViewDef")
@Scope("prototype")
public class IOViewDef extends ViewDef{
    @Autowired
    public IOViewDef(OpenInfoButtonLinkGenerator linkgen, Environment env) {
        ...
        QueryDef qry = new QueryDef("io-observations", "?:range.startHL7", "?:range.endHL7");
