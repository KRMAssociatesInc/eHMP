...
/**
 * This class is used to load the medication information from the JLV DOD_MEDICATIONS spreadsheet page into
 * the dod_medications table in the h2 database.
 * 
 * @author Les.Westberg
 */
public class JLVH2DodMedicationsLoadUtil implements IJLVH2PageLoadUtil {
	private static final String PAGE_NAME = "DOD_MEDICATIONS";
	private static final String CRLF = System.getProperty("line.separator");
	private static final Object TITLE_ROW_CELL_1_TEXT = "id";
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS dod_medications (id INT PRIMARY KEY, " + 
	                                                                                           "dodNcid VARCHAR(20), " + 
	                                                                                           "dodName VARCHAR(500)," +
			                                                                                   "mmmName VARCHAR(500)," +
			                                                                                   "rxnorm VARCHAR(20))";
	private static final String SQL_CLEAR_ALL = "DELETE FROM dod_medications";
	private static final String SQL_INSERT = "INSERT INTO dod_medications VALUES (?, ?, ?, ?, ?)";
	...
	private static final int SQL_FIELD_RXNORM = 5;
	...
	private JLVH2DodMedicationsLoadUtil () {
	}
	 ...
	 */
	public JLVH2DodMedicationsLoadUtil(String sMapFileName, FileInputStream fisMapFile, Connection oDBConnection, PrintWriter pwStatusFile) throws TermLoadException {
	...
	private class RowMapping {
		...
		private static final int CELL_RXNORM = 4;
