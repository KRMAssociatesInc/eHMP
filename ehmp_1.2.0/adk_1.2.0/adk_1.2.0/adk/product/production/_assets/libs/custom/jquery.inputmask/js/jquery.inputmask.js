        ...
        function maskScope(actionObj, maskset, opts) {
            ...
            function patchValueProperty(npt) {
                ...
                function InstallNativeValueSetFallback(npt) {
                    // Does not work with placeholders workaround for IE9. Once updated to higher IE -> uncomment
            ...
            function mask(el) {
                ...
                if ($el.is(":input") && !isInputTypeSupported($el.attr("type"))) {
                    ...
                    $el/*.bind("mouseenter.inputmask", function () { // Does not work with placeholders workaround for IE9. Once updated to higher IE -> uncomment
                        ...
                        valueOnFocus = getBuffer().join('');
                    })/*.bind("mouseleave.inputmask", function () { // Does not work with placeholders workaround for IE9. Once updated to higher IE -> uncomment
                        var $input = $(this), input = this;
                        if (opts.clearMaskOnLostFocus) {
