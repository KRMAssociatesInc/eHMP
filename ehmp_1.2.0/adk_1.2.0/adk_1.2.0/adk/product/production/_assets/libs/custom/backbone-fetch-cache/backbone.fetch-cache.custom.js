...
(function (root, factory) {
  ...
  supportLocalStorage = (function() {
    ...
    if (supported) {
      try {
        ...
        sessionStorage.setItem("test_support", "test_support");
  ...
  function setLocalStorage() {
    ...
    try {
      sessionStorage.setItem(Backbone.fetchCache.getLocalStorageKey(), JSON.stringify(Backbone.fetchCache._cache));
    } catch (err) {
  ...
  function getLocalStorage() {
    if (!supportLocalStorage || !Backbone.fetchCache.localStorage) { return; }
    var json = sessionStorage.getItem(Backbone.fetchCache.getLocalStorageKey()) || '{}';
