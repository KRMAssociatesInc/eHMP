...
DELSITE ;; @TEST Delete a site's patient data
 ...
 D ASSERT(10,$D(^VPRPT(VPRJTPID1)))
 D ASSERT(10,$D(^VPRPTJ("JSON",VPRJTPID1)))
 D ASSERT(10,$D(^VPRPTJ("TEMPLATE",VPRJTPID1)))
 D ASSERT(1,^VPRPTI(VPRJTPID1,"tally","collection","patient"))
 D ASSERT(10,$D(^VPRPT(VPRJTPID2)))
 D ASSERT(10,$D(^VPRPTJ("JSON",VPRJTPID2)))
 D ASSERT(10,$D(^VPRPTJ("TEMPLATE",VPRJTPID2)))
 D ASSERT(1,^VPRPTI(VPRJTPID2,"tally","collection","patient"))
 D DELSITE^VPRJPS("93EF")
 D ASSERT(0,$D(^VPRPT(VPRJTPID1)))
 D ASSERT(0,$D(^VPRPTJ("JSON",VPRJTPID1)))
 D ASSERT(0,$D(^VPRPTJ("TEMPLATE",VPRJTPID1)))
 D ASSERT(0,^VPRPTI(VPRJTPID1,"tally","collection","patient"))
 D ASSERT(0,$D(^VPRPT(VPRJTPID2)))
 D ASSERT(0,$D(^VPRPTJ("JSON",VPRJTPID2)))
 D ASSERT(0,$D(^VPRPTJ("TEMPLATE",VPRJTPID2)))
 D ASSERT(0,^VPRPTI(VPRJTPID2,"tally","collection","patient"))
 Q
