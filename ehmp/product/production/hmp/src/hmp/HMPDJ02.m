...
GMPL1(ID,POVLST) ; -- problem
 ...
 I $G(HMPMETA)=1 D ADD^HMPMETA("problem",PROB("uid"),PROB("stampTime")) Q  ;US6734
...
GMRA1(ID) ; -- allergy/reaction GMRAL(ID)
 ...
 ;US6734 - pre-compile metastamp
 I $G(HMPMETA)=1 D ADD^HMPMETA("allergy",REAC("uid"),REAC("stampTime")) Q  ;US6734
...
GMV1(ID) ; -- vital/measurement ^UTILITY($J,"GMRVD",HMPIDT,HMPTYP,ID)
 ...
 ;US6734 - pre-compile metastamp
 I $G(HMPMETA) D ADD^HMPMETA("vital",VIT("uid"),VIT("stampTime")) Q  ;US6734
