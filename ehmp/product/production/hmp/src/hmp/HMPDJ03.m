...
GMRC1(ID) ; -- consult/request HMPX=^TMP("GMRCR",$J,"CS",HMPN,0)
 ...
 I $G(HMPMETA)=1 D ADD^HMPMETA("consult",CONS("uid"),CONS("stampTime")) Q  ;US6734
...
MC1(ID) ; -- clinical procedure HMPX=^TMP("MDHSP",$J,HMPN)
 ...
 ;US6734 - pre-compile metastamp
 I $G(HMPMETA)=1 D ADD^HMPMETA("procedure",PROC("uid"),PROC("stampTime")) Q  ;US6734
...
MDC1(ID) ; -- clinical observation
 ...
 ;US6734 - pre-compile metastamp
 I $G(HMPMETA)=1 D ADD^HMPMETA("obs",CLIO("uid"),CLIO("stampTime")) Q  ;US6734
