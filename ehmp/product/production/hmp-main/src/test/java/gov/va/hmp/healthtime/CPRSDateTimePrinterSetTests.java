...
public class CPRSDateTimePrinterSetTests {

    private CPRSDateTimePrinterSet printers = new CPRSDateTimePrinterSet();

    @Test
    public void testDateTimePrinter() throws Exception {
        PointInTime t = new PointInTime(1984, 3, 11, 22, 56, 56);
        assertThat(printers.dateTime().print(t, Locale.ENGLISH), is("Mar 11,84 22:56"));
        t = new PointInTime(1984, 3, 11, 22, 56);
        assertThat(printers.dateTime().print(t, Locale.ENGLISH), is("Mar 11,84 22:56"));
        t = new PointInTime(1984, 3, 11, 22);
        assertThat(printers.dateTime().print(t, Locale.ENGLISH), is("Mar 11,84")); // Mar 11,84 22-23 maybe?
        t = new PointInTime(1984, 3, 11);
        assertThat(printers.dateTime().print(t, Locale.ENGLISH), is("Mar 11,84"));
    ...
    public void testDatePrinter() throws Exception {
        ...
        assertThat(printers.date().print(t, Locale.ENGLISH), is("Jul 23,75"));
