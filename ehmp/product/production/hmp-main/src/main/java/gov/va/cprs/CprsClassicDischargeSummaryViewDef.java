...
@Component(value = "gov.va.cprs.CprsClassicDischargeSummaryViewDef")
@Scope("prototype")
public class CprsClassicDischargeSummaryViewDef extends ViewDef {
	public CprsClassicDischargeSummaryViewDef() {
...
//    	querydef.fields().alias("clinicians", "author").alias("providers", "author");
    	...
    	querydef.where("kind").is("Discharge Summary");
