...
@Component(value = "gov.va.cprs.CprsClassicConsultsViewDef")
@Scope("prototype")
public class CprsClassicConsultsViewDef extends ViewDef {
	public CprsClassicConsultsViewDef() {
