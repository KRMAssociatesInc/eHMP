...
/**
 * This class is used to load the vitals information from the JLV vitals spreadsheet page into
 * the vitals table in the h2 database.
 * 
 * @author Les.Westberg
 */
public class JLVH2VitalsLoadUtil implements IJLVH2PageLoadUtil {
	private static final String PAGE_NAME = "VITALS";
	private static final String CRLF = System.getProperty("line.separator");
	private static final Object TITLE_ROW_CELL_1_TEXT = "id";
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS vitals (id INT PRIMARY KEY, " + 
	                                                                                   "dodNcid VARCHAR(20), " + 
	                                                                                   "vuid VARCHAR(20)," +
	                                                                                   "loinc VARCHAR(20)," +
	                                                                                   "loincName VARCHAR(500))";
	private static final String SQL_CLEAR_ALL = "DELETE FROM vitals";
	private static final String SQL_INSERT = "INSERT INTO vitals VALUES (?, ?, ?, ?, ?)";
	...
	private static final int SQL_FIELD_LOINC = 4;
	private static final int SQL_FIELD_LOINC_NAME = 5;
	 ...
	 */
	public JLVH2VitalsLoadUtil(String sMapFileName, FileInputStream fisMapFile, Connection oDBConnection, PrintWriter pwStatusFile) throws TermLoadException {
	...
	private class RowMapping {
		...
		private static final int CELL_VUID = 2;
		private static final int CELL_LOINC = 3;
		private static final int CELL_LOINC_NAME = 4;
