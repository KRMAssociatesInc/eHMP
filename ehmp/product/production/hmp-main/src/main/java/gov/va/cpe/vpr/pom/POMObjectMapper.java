...
import gov.va.hmp.healthtime.jackson.*;
...
import gov.va.hmp.web.json.GrantedAuthorityJacksonAnnotations;
import gov.va.hmp.web.json.UserDetailsJacksonAnnotations;
import gov.va.hmp.web.json.VistaUserDetailsJacksonAnnotations;
