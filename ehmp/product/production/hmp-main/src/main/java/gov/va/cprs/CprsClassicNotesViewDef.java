...
@Component(value = "gov.va.cprs.CprsClassicNotesViewDef")
@Scope("prototype")
public class CprsClassicNotesViewDef extends ViewDef {
	public CprsClassicNotesViewDef() {
...
//    	querydef.fields().alias("clinicians", "author").alias("providers", "author");
    	...
    	querydef.where("kind").in(Arrays.asList("Progress Note","Crisis Note","Advance Directive"));
        Query q1 = addQuery(new ScreenedJDSQuery("uid", querydef));
    		
		addColumns(q1, "uid", "summary", "kind", "authorDisplayName", "facilityCode", "facilityName", "domainClass");
