define(['moment'], function() {
    function chartBuilder(model) {
        ...
        var oldest = fromDate.valueOf() /*model.get('graphRelativeityOldestTime')*/ ;
        var newest = toDate.valueOf() /*model.get('graphRelativeityNewestTime')*/ ;

        localListGraphData.chart.plotBackgroundColor = '#F2F2F2';
        localListGraphData.chart.height = 25;
        ...
        for (var t = 0; t < facilityCollection.length; t++) {
            ...
            if (facilityCollection.length > 1) {
                thirtytwo = 20;
                localListGraphData.chart.height = 25 * facilityCollection.length;
            }
